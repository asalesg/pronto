...
ReactDOM.createRoot(document.getElementById('root')!).render(
  <React.StrictMode>
    ...
    <button className='text-xs m-5 p-2 white rounded-md border border-violet-500 font-bold flex justify-center items-center center'><a target="_blank" href="https://asalesg.github.io/portfolio/">Clique aqui para ter mais informações minhas</a></button>
    <App />
  </React.StrictMode>
)
